...
class CbrtOp(_ods_ir.OpView):
  ...
  def __init__(self, operand, *, result_accuracy=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
  ...
  def result_accuracy(self, value):
    if value is not None:
...
def cbrt(operand, *, result_accuracy=None, loc=None, ip=None) -> _ods_ir.Value:
  return CbrtOp(operand=operand, result_accuracy=result_accuracy, loc=loc, ip=ip).result
...
def cosine(operand, *, result_accuracy=None, loc=None, ip=None) -> _ods_ir.Value:
  return CosineOp(operand=operand, result_accuracy=result_accuracy, loc=loc, ip=ip).result
...
class CustomCallOp(_ods_ir.OpView):
  ...
  def __init__(self, result, inputs, call_target_name, *, has_side_effect=None, backend_config=None, api_version=None, called_computations=None, operand_layouts=None, result_layouts=None, output_operand_aliases=None, loc=None, ip=None):
    ...
    if backend_config is not None: attributes["backend_config"] = (backend_config if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_768')) else
          _ods_ir.AttrBuilder.get('anonymous_768')(backend_config, context=_ods_context))
    ...
    if output_operand_aliases is not None: attributes["output_operand_aliases"] = (output_operand_aliases if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_774')) else
          _ods_ir.AttrBuilder.get('anonymous_774')(output_operand_aliases, context=_ods_context))
    results.extend(result)
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
def exponential(operand, *, result_accuracy=None, loc=None, ip=None) -> _ods_ir.Value:
  return ExpOp(operand=operand, result_accuracy=result_accuracy, loc=loc, ip=ip).result
...
def exponential_minus_one(operand, *, result_accuracy=None, loc=None, ip=None) -> _ods_ir.Value:
  return Expm1Op(operand=operand, result_accuracy=result_accuracy, loc=loc, ip=ip).result
...
def log_plus_one(operand, *, result_accuracy=None, loc=None, ip=None) -> _ods_ir.Value:
  return Log1pOp(operand=operand, result_accuracy=result_accuracy, loc=loc, ip=ip).result
...
def log(operand, *, result_accuracy=None, loc=None, ip=None) -> _ods_ir.Value:
  return LogOp(operand=operand, result_accuracy=result_accuracy, loc=loc, ip=ip).result
...
def logistic(operand, *, result_accuracy=None, loc=None, ip=None) -> _ods_ir.Value:
  return LogisticOp(operand=operand, result_accuracy=result_accuracy, loc=loc, ip=ip).result
...
def rsqrt(operand, *, result_accuracy=None, loc=None, ip=None) -> _ods_ir.Value:
  return RsqrtOp(operand=operand, result_accuracy=result_accuracy, loc=loc, ip=ip).result
...
def sine(operand, *, result_accuracy=None, loc=None, ip=None) -> _ods_ir.Value:
  return SineOp(operand=operand, result_accuracy=result_accuracy, loc=loc, ip=ip).result
...
def sqrt(operand, *, result_accuracy=None, loc=None, ip=None) -> _ods_ir.Value:
  return SqrtOp(operand=operand, result_accuracy=result_accuracy, loc=loc, ip=ip).result
...
def tan(operand, *, result_accuracy=None, loc=None, ip=None) -> _ods_ir.Value:
  return TanOp(operand=operand, result_accuracy=result_accuracy, loc=loc, ip=ip).result
...
def tanh(operand, *, result_accuracy=None, loc=None, ip=None) -> _ods_ir.Value:
  return TanhOp(operand=operand, result_accuracy=result_accuracy, loc=loc, ip=ip).result
