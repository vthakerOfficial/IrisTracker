...
class ExtractElementOp(_ods_ir.OpView):
  ...
  def __init__(self, vector, *, position=None, loc=None, ip=None):
    ...
    if position is not None: operands.append(position)
    _ods_context = _ods_get_default_loc_context(loc)
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
class InsertOp(_ods_ir.OpView):
  ...
  def __init__(self, valueToStore, dest, dynamic_position, static_position, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def insert(value_to_store, dest, dynamic_position, static_position, *, loc=None, ip=None) -> _ods_ir.Value:
  return InsertOp(valueToStore=value_to_store, dest=dest, dynamic_position=dynamic_position, static_position=static_position, loc=loc, ip=ip).result
...
class InsertStridedSliceOp(_ods_ir.OpView):
  ...
  def __init__(self, valueToStore, dest, offsets, strides, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def insert_strided_slice(value_to_store, dest, offsets, strides, *, loc=None, ip=None) -> _ods_ir.Value:
  return InsertStridedSliceOp(valueToStore=value_to_store, dest=dest, offsets=offsets, strides=strides, loc=loc, ip=ip).result
...
class ScalableInsertOp(_ods_ir.OpView):
  ...
  def __init__(self, valueToStore, dest, pos, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def scalable_insert(value_to_store, dest, pos, *, loc=None, ip=None) -> _ods_ir.Value:
  return ScalableInsertOp(valueToStore=value_to_store, dest=dest, pos=pos, loc=loc, ip=ip).result
...
class TransferWriteOp(_ods_ir.OpView):
  ...
  def __init__(self, result, valueToStore, source, indices, permutation_map, in_bounds, *, mask=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def transfer_write(result, value_to_store, source, indices, permutation_map, in_bounds, *, mask=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TransferWriteOp(result=result, valueToStore=value_to_store, source=source, indices=indices, permutation_map=permutation_map, in_bounds=in_bounds, mask=mask, loc=loc, ip=ip))
